...
For some reason, FTD is not able to create a CSR without FMC (Firepower Management Center), so we will use the help of [Certificate Tools](https://certificatetools.com/) to do that
