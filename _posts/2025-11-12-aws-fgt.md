...
AWS is Amazon’s cloud platform that provides on-demand compute, storage, networking, and security services. Instead of running hardware in a physical data center, we can deploy virtual infrastructure in minutes and scale it as needed.
...
![x](/static/2025-11-12-aws-fgt/04a.png)
...
It usually takes a couple minutes for it to be complete
...
Now we'll create 1 VPC with 2 Subnets as the inside and outside network for our fortigate, to do that go to VPC >> Your VPCs >> Create VPC on 10.0.0.0/16 CIDR
