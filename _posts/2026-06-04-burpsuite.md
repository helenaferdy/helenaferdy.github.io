...
### 1. The Proxy Tab → Module: IDOR (Insecure Direct Object References)
...
### 2. The Repeater Tab → Module: SQL Injection
...
### 3. The Intruder Tab → Module: Broken Authentication & Captcha Bypass
...
### 4. The Decoder Tab → Module: Path Traversal / File Inclusion
...
### 5. The Comparer Tab → Module: Command Injection
...
### 6. The Sequencer Tab → Module: CSRF / Session Tracking
