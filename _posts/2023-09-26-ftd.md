---
title: Install Cisco FTD (Firewall Threat Defense) Firewall
...
## What is Cisco Firewall Threat Defense?
...
## Installing Firewall Threat Defense
...
## Accessing Firewall Threat Defense
...
On Policies >> NAT, add a new Static NAT coming from outside to inside with the spcecified destination IP address
