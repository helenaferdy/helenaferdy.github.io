...
We add 2 more VPCs, A-VPC and B-VPC on top of already existinf helena-VPC
...
We confirm that this host can access host on VPC B, VPC Helena, as well as to Internet though VPC Helena and the firewall configure there
...
This host can also access host on VPC A, VPC Helena and the Internet
