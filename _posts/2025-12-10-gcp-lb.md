...
Next we create an Unmanaged Instance Group to contains these 2 linux servers
...
Next we will configure Cloud Armor to better protect our web servers, to do that we'll create a new Cloud Amor Policy with Backend type at Application Layer

![x](/static/2025-12-10-gcp-lb/22.png)

<br>

After that we add a new rule to apply throtling for IP Address that has more than 5 requests in 1 minute
